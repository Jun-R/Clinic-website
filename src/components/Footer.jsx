...
<a href="#about" className="opacity-80 hover:opacity-100">소개</a>
<a href="#gallery" className="opacity-80 hover:opacity-100">갤러리</a>
<a href="#location" className="opacity-80 hover:opacity-100">오시는 길</a>
</div>
</div>
</footer>
);
